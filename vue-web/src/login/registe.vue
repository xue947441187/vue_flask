    ...
    <div class="col-xs-6 col-sm-4 tab">
        <div><span><h1 class="size">用户注册页面</h1></span>
            ...
            <div class="input-group input-div">
                ...
                <input @blur="this.password" v-model="authlist.password" id="password"
                       title="请输入字母数字下划线，最少输入六位且不可与用户名相同"
                       type="password"
                       class="form-control"
            ...
            <div class="input-group input-div">
                ...
                <input @blur="this.email" v-model="authlist.email" id="email" type="text"
                       title="输入您的邮箱，目前仅支持163邮箱以及qq邮箱"
                       class="form-control"
                       placeholder="email"
                       aria-describedby="basic-addon1">
